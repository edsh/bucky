...
>
  <img src="{base}/d-eelk.gif" alt="Die D-EELK als Pixelgrafik" />
</div>

<main>
  <p class="zurueck"><a href="{base}/">Zurück zur Auswahl</a></p>
  <header class="kopf">
  ...
  <p class="einleitung">
    ...
    Flughandbuch-Anhangs — <a href="{base}/d-eelk/poh-rechner/tabellen">die verwendeten Tabellen im Einzelnen</a>.
  </p>
...
<style>
  ...
  */
  ...
  /*
    Der Rueckweg steht ueber der Ueberschrift und nicht am Seitenende: Ohne
    ihn waere die Startseite nach dem ersten Klick fuer immer verlassen
    (Feature 043, FR-016), und am Ende einer derart langen Seite faende ihn
    niemand.
  */
  .zurueck {
    margin: 0 0 0.75rem;
