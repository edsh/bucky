...
- [ ] T013 [P] Die eine Rundungs- und Zahlendarstellungsstelle des Projekts (Kraftstoff auf 0,1 l, Zeiten auf ganze Minuten, Strecken auf 0,1 NM, Geschwindigkeiten auf ganze Knoten, FR-021) in `packages/deelk-poh-core/src/format.ts` (Zusicherung C-03)
